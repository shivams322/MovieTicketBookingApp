...
IF EXISTS (select top 1 1 from [dbo].[Show])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Altering Table [dbo].[Show]...';


GO
ALTER TABLE [dbo].[Show] ALTER COLUMN [Date] DATETIME NOT NULL;

ALTER TABLE [dbo].[Show] ALTER COLUMN [EndTime] DATETIME NOT NULL;

ALTER TABLE [dbo].[Show] ALTER COLUMN [StartTime] DATETIME NOT NULL;


GO
PRINT N'Refreshing Procedure [dbo].[Ticket]...';
